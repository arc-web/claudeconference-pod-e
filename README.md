...
![](https://img.shields.io/badge/Pod_E-6_Members-F5A623?style=for-the-badge)
...
| | Name | Role | Computer |
|---|------|------|----------|
| 👑  **Cris Militante** | Pod Leader | Mac |
|     **Karen Pearl V. Pabilando** | Member | Mac |
|     **Kael** | Member | - |
|     **John Rowen C. Miano** | Member | Windows |
|     **Christian Joseph M. Delos Santos** | Member | Windows |
|     **Shannen Nazareno** | Member | Windows |

**Cris Militante** is your pod leader - they keep things moving, call votes when the group is stuck, and make sure everyone has something to do. The leader can hand the role to someone else if they want to.
...
- **Discord - Pod E channel** - https://discord.gg/g2pJzjmV
