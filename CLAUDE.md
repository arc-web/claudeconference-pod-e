# Workshop Context - Pod E

You are working with Pod E at the StellarPH x KMC Claude AI Workshop in Cebu, Philippines, April 10, 2026.
...
- Cris Militante (Pod Leader) - Has a Claude subscription, on Mac
- Karen Pearl V. Pabilando - Has a Claude subscription, on Mac
- Kael - Has a Claude subscription, on unknown
- John Rowen C. Miano - Has used AI coding tools before, on Windows
- Christian Joseph M. Delos Santos - Has used AI coding tools before, on Windows
- Shannen Nazareno - New to AI tools, on Windows

Pod Leader: Cris Militante - keeps the team moving, calls votes when stuck, makes sure everyone has something to do.
